...
浏览器京东登录页面：https://plogin.m.jd.com/login/login

*/

const $ = new Env('京东签到领京豆');
//导入京东cookie数组
...
console.log("处理前：jdCookieNode="+jdCookieNode)
console.log("处理后：cookiesArr="+cookiesArr)
